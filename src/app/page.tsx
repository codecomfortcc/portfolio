        ...
        <div className="grid lg:grid-cols-3  grid-cols-1  gap-x-3 gap-y-3 w-full  px-2 ">
          <HoverCard
            info={{
              title: "Hoobank",
              description:
                "A frontend webpage for banking sector with beautiful landing page",
              image: Hoobank,
              id: "/projects/hoobank",
          ...
          <HoverCard
            info={{
              title: "Case Code",
              description:
                "A simple e-commerce website to purchase phone cases",
              image: CaseCode,
          ...
          <HoverCard
            info={{
              title: "DesignTec",
              description:
                "A simple e-commerce website to view and purchase designtec products",
              image: Capture,
          ...
          <div className="border-dash-long w-full mt-10 rounded-lg">
            <Card>
              <CardContent className="px-4">
                ...
                <CardDescription className="text-sm max-w-[600px] text-gray-700 py-2   text-foreground">
                  "Yasovardhan is a MERN stack developer who I hired to debug my
                  Omegle clone project. He understood my problem clearly and
                  assist to build a high-quality application. Yasovardhan was
                  communicative and always available to address my concerns."
                </CardDescription>
                <div className="flex justify-between items-center mt-5">
                  <Image
                    src={Checkout}
